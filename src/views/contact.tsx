          ...
          <Row className='contact d-flex'>
            <Col className='contact-form'>
              ...
              <Form className='mt-4'>
                <Row>
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                      ...
                      <Form.Control className='text-field' type="text" placeholder="Your Name" />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                      <Form.Label>Email</Form.Label>
                      <Form.Control className='text-field' type="email" placeholder="xyz@company.com" />
                    </Form.Group>
                  </Col>
                </Row>
                <Row className='mt-40'>
                ...
                <Form.Label className='mt-40 mb-3'>I’m interested in…</Form.Label>
                <Row>
                  {checks.map((field) => (
                ...
                <Button onClick={() => handleSubmit()} variant="dark" className='button-outline mt-40'>LET'S GET STARTED</Button>
              </Form>
            </Col>
            <Col><img src={ContactImg} /></Col>
          </Row>) : (
          <Row className='contact d-flex'>
